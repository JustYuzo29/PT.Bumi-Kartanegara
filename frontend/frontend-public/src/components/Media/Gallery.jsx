...
const GalleryArrowShape = ({ t }) => {
  ...
  return (
    <section
      className="py-12 bg-[var(--color-pages)] text-[var(--color-text)] flex justify-center px-0 relative min-h-[500px] mt-32 transition-colors duration-300"
      data-aos="fade-up"
    ...
    >
      ...
      <div className="absolute top-0 right-10 max-w-sm text-right z-10 mb-40">
        ...
        <p
          className="text-sm leading-relaxed text-[var(--color-text)] mt-4"
          data-aos="fade-down"
          data-aos-delay="200"
        >
