...
const GalleryArrowShape = () => {
  ...
  return (
    <section
      className="py-12 bg-white flex justify-center px-0 relative min-h-[500px] mt-32"
      data-aos="fade-up"
      data-aos-duration="1000"
    >
      {/* Teks di kanan atas, absolute */}
      <div className="absolute top-0 right-10 max-w-sm text-right z-10 mb-40">
        ...
        <p
          className="text-sm leading-relaxed text-gray-700 mt-4"
          data-aos="fade-down"
          data-aos-delay="200"
        >
          Jelajahi portofolio gambar yang merefleksikan dedikasi, keahlian, dan
          standar kualitas kami dalam setiap tahapan proyek konstruksi, rekayasa
          sipil, dan layanan suplai.
        </p>
      </div>

      {/* Galeri di kiri, beri margin bawah dan margin atas */}
