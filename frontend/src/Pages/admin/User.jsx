...
import SectionTitle from "../../components/admin/user/SectionTitle";
import AddButton from "../../components/admin/user/AddButton";
import SectionCard from "../../components/admin/user/SectionCard";
...
const User = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const cleanedUsers = data.map(({ id, username, email, tipe }) => ({
        id,
        name: username, // pakai username untuk kolom nama
        email,
