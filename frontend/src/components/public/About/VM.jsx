  ...
  return (
    <section className="relative w-full min-h-[130vh] px-4 md:px-12 lg:px-20 py-20 md:py-28 z-10 overflow-hidden">
      ...
      <div className="flex flex-col justify-center gap-10 md:gap-16 max-w-7xl mx-auto h-full">
        {/* VISI */}
        <div
          className="card-light backdrop-blur-lg rounded-3xl shadow-2xl p-6 md:p-10 flex flex-col md:flex-row gap-6 items-center"
          data-aos="fade-up"
        >
        ...
        {/* MISI */}
        <div
          className="card-light backdrop-blur-lg rounded-3xl shadow-2xl p-6 md:p-10 flex flex-col md:flex-row-reverse gap-6 items-center"
          data-aos="fade-up"
        >
          <div className="w-full md:w-1/2">
            <img
