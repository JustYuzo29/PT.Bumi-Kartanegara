...
const Struktur = () => {
  ...
  return (
    <section className="relative z-20 bg-struktur text-white pb-40 overflow-hidden rounded-t-[40px] -mt-[80px]">
      ...
      <div className="relative z-10 pt-16">
        ...
        <div className="flex flex-col items-center relative space-y-14">
          <div className="absolute top-[120px] h-[400px] w-[2px] struktur-line z-0" />

          {/* Direktur Utama */}
          <div data-aos="zoom-in" className="relative z-10">
            <div className="struktur-card rounded-xl p-4 shadow-md w-[150px] text-center">
              <img
                src={Struktur0}
          ...
          <div className="flex justify-center items-center relative z-0">
            <div className="w-[300px] h-[2px] struktur-line" />
          </div>
          ...
          <div className="w-[500px] h-[2px] struktur-line mx-auto mt-10 z-0" />
          ...
          >
            {t.strukturNodes.divisi.map((item, idx) => (
              <div
                key={idx}
                className="struktur-card rounded-xl p-4 shadow-md w-[130px] text-center"
              >
                <img
                  src={Struktur3}
                  alt={item.nama}
